...
*/
class HTML_Template_Flexy_Compiler_Xipe_Internal extends HTML_Template_Flexy_Compiler_Xipe
{
...
//     >{%trim $aFolder['extName'] after 40 "..."%}
        ...
        require_once 'HTML/Template/Flexy/Compiler/Xipe/Basic.php';

        $preFilter = new  _HTML_Template_Flexy_Compiler_Xipe_Basic;
