...
*/
class HTML_Template_Flexy_Compiler_Xipe_QuickForm extends HTML_Template_Flexy_Compiler_Xipe
{
    /**
    ...
    */
    ...
    function HTML_Template_Flexy_Compiler_Xipe_QuickForm($options=array(),$namespace='form')
    {
