...
*   @version    01/12/15
*/
class HTML_Template_Flexy_Compiler_Xipe_TagLib extends HTML_Template_Flexy_Compiler_Xipe
{
...
print "<b>Xipe-Error</b><br>The file <b>{$_aInclude}</b> is included recursively, this is not possible!<br>";
            ...
            //print "including: $contentFile<br>";
                                    ...
                                    $testVar = "\$___HTML_Template_Flexy_Compiler_Xipe_TagLib_includedFile['$fileToInclude']";
                                    $fileContent =  "$_openDel if(!isset($testVar) || !$testVar)\\\{ $_closeDel".
                                                    $fileContent.
                                                    $_openDel." \$___HTML_Template_Flexy_Compiler_Xipe_TagLib_includedFile['$fileToInclude']=true;\\\}".$_closeDel;
                                } else {
